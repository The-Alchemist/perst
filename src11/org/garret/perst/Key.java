...
public class Key { 
    ...
    /**
     * Constructor of fixed size array of byte key (boundary is inclusive)
     */
    public Key(byte[] v, int size) { 
        this(v, size, true);
    }
    ...
    /**
     * Constructor of fixed size byte array key
     * @param v byte array value
     * @param size byte array size 
     * @param inclusive whether boundary is inclusive or exclusive
     */
    public Key(byte[] v, int size, boolean inclusive) { 
        this(Types.ArrayOfByte, size, 0.0, v, inclusive);        
    }
}
