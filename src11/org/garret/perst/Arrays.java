...
public class Arrays { 
    ...
    public static boolean equals(Object[] arr1, Object[] arr2) { 
        ...
        for (int i = 0; i < arr1.length; i++) { 
            if (arr1[i] != arr2[i] && (arr1[i] == null || !arr1[i].equals(arr2[i]))) { 
                return false;
            }
        }
        return true;
    ...
    public static int compare(byte[] arr1, int off1, byte[] arr2, int off2, int len) { 
        for (int i = 0; i < len; i++) { 
            if (arr1[i+off1] != arr2[i+off2]) { 
                return arr1[i+off1] - arr2[i+off2];
            }
        }
        return 0;
    }
