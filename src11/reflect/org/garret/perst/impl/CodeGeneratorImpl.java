...
class CodeGeneratorImpl implements CodeGenerator
{
    ...
    public Code literal(long value) {
        return new IntLiteralNode(value);
    }
        
    public Code literal(double value) {
        return new RealLiteralNode(value);
    }
        
    public Code literal(Object value) {
        if (value instanceof Long || value instanceof Integer || value instanceof Short || value instanceof Byte) {
            return new IntLiteralNode(Number.longValue(value));
        } else if (value instanceof Double || value instanceof Float) { 
            return new RealLiteralNode(Number.doubleValue(value));
    ...
    public Code field(Code base, String name) {
        ...
        Field f = QueryImpl.lookupField(scope, name);                    
        if (f == null) {             
    ...
    public Code invoke(Code base, String name, Code[] arguments) {
        ...
        Class scope = (base == null) ? cls : ((Node)base).getType();
        Method mth = QueryImpl.lookupMethod(scope, name);
        if (mth == null) { 
    ...
    public void orderBy(String name, boolean ascent) { 
        Field f = QueryImpl.lookupField(cls, name);
        OrderNode node;
        if (f == null) {
            Method m = QueryImpl.lookupMethod(cls, name);
            if (m == null) { 
