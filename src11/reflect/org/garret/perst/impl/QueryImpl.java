...
class FilterIterator extends Iterator { 
    ...
    public int nextOid() { 
        ...
        int oid = ((IPersistent)currObj).getOid();
        currObj = null;
        return oid;
    }
...
class UnionIterator extends Iterator { 
    ...
    Enumeration alternativesIterator;
    Object currObj;
    int keyType;

    UnionIterator(GenericIndex index, Iterator currIterator, Vector alternatives) { 
        this.index = index;
        this.currIterator = currIterator;
        this.alternativesIterator = alternatives.elements();
        keyType = index.getKeyType();
    }
    
    Key createKey(Object value) { 
        switch (keyType) { 
        case Types.Boolean:
            return new Key(((Boolean)value).booleanValue());
        case Types.Byte:
            return new Key(((Byte)value).byteValue());
        case Types.Short:
            return new Key(((Short)value).shortValue());
        case Types.Char:
            return new Key(((Character)value).charValue());
        case Types.Int:
            return new Key(((Integer)value).intValue());
        case Types.Object:
            return new Key((IPersistent)value);
        case Types.Long:
            return new Key(((Long)value).longValue());
        case Types.Date:
            return new Key((Date)value);
        case Types.Float:
            return new Key(((Float)value).floatValue());
        case Types.Double:
            return new Key(((Double)value).doubleValue());
        case Types.String:
            return new Key((String)value);
        case Types.ArrayOfByte:
            return new Key((byte[])value);
         default:
    ...
    public boolean hasNext() { 
        ...
        while (currIterator == null || !currIterator.hasNext()) { 
            if (!alternativesIterator.hasMoreElements()) { 
                return false;
            }
            Key key = createKey(alternativesIterator.nextElement());
            currIterator = index.iterator(key, key, Index.ASCENT_ORDER);
        }
...
class JoinIterator extends Iterator { 
    ...
    public boolean hasNext() { 
        ...
        while (joinIterator == null || !joinIterator.hasNext()) { 
            ...
            IPersistent obj = (IPersistent)iterator.next();
            Key key = new Key(obj);
...
class Node implements CodeGenerator.Code { 
    ...
    boolean evaluateBool(FilterIterator t) { 
        throw new Error("Abstract method Node.evaluateBool");
    }
    long    evaluateInt(FilterIterator t) {
        throw new Error("Abstract method Node.evaluateInt");
    }
    double  evaluateReal(FilterIterator t) {
        throw new Error("Abstract method Node.evaluateReal");
    }
    ...
    Object  evaluateObj(FilterIterator t) {
        switch (type) { 
          ...
          default:
              throw new Error("Abstract method Node.evaluateObj");
        }
    }
    Class   getType() { 
        return null;
...
class InvokeNode extends Node {
    ...
    long evaluateInt(FilterIterator t) {
        ...
        try { 
            return Number.longValue(mth.invoke(obj, parameters));
        } catch (Exception x) { 
            x.printStackTrace();
    ...
    double evaluateReal(FilterIterator t) {
        ...
        Object[] parameters = evaluateArguments(t);
        try { 
            return Number.doubleValue(mth.invoke(obj, parameters));
        } catch (Exception x) { 
            x.printStackTrace();
            throw new Error("Method invocation error");
        }
...
class InvokeAnyNode extends Node { 
    ...
    Object evaluateObj(FilterIterator t) {
        ...
        if (target == null && t.containsElem != null) { 
            if ((m = QueryImpl.lookupMethod(t.containsElem.getClass(), methodName)) != null) {
                return t.query.resolve(m.invoke(t.containsElem, parameters));
            }
        }
        cls = obj.getClass();
        if ((m = QueryImpl.lookupMethod(cls, methodName)) != null) { 
            return t.query.resolve(m.invoke(t.containsElem, parameters));
        } 
...
class ConvertAnyNode extends Node { 
    ...
    long evaluateInt(FilterIterator t) { 
        return Number.longValue(evaluateObj(t));
    }

    double evaluateReal(FilterIterator t) { 
        return Number.doubleValue(evaluateObj(t));
    }
...
class BinOpNode extends Node { 
    ...
    Object evaluateObj(FilterIterator t) { 
        ...
        {
            double r1 = Number.doubleValue(lval);
            double r2 = Number.doubleValue(rval);
            switch (tag) {
              case opAnyAdd:
            ...
            long i1 = Number.longValue(lval);
            long i2 = Number.longValue(rval);
            long res;
            switch (tag) { 
              case opAnyAdd:
    ...
    static boolean areEqual(Object a, Object b) { 
        ...
        if (a instanceof Double || a instanceof Float || b instanceof Double || b instanceof Float) { 
            return Number.doubleValue(a) == Number.doubleValue(b);
        } else if (Number.isNumber(a)) {
            return Number.longValue(a) == Number.longValue(b);
        } else if (a != null) { 
            return a.equals(b);
        }
        return false;
    ...
    boolean evaluateBool(FilterIterator t) {
        switch (tag) { 
          ...
          case opStrIgnoreCaseLt:
              return left.evaluateStr(t).toLowerCase().compareTo(right.evaluateStr(t).toLowerCase()) < 0;
          ...
          case opDateNe: 
            return !left.evaluateDate(t).equals(right.evaluateDate(t));            
          case opDateLt: 
            return left.evaluateDate(t).getTime() < right.evaluateDate(t).getTime();          
          case opDateLe: 
            return left.evaluateDate(t).getTime() <= right.evaluateDate(t).getTime();          
          case opDateGt: 
            return left.evaluateDate(t).getTime() > right.evaluateDate(t).getTime();          
          ...
          case opScanCollection:
            return ((Vector)right.evaluateObj(t)).contains(left.evaluateObj(t));
...
class CompareNode extends Node {
    ...
    boolean evaluateBool(FilterIterator t) {
        switch(tag) { 
          ...
          {
            String val = o1.evaluateStr(t);
            return val.toLowerCase().compareTo(o2.evaluateStr(t).toLowerCase()) >= 0 
                && val.toLowerCase().compareTo(o3.evaluateStr(t).toLowerCase()) <= 0;
          }
          case opDateBetween:
          {
            long val = o1.evaluateDate(t).getTime();
            return val >= o2.evaluateDate(t).getTime() 
                && val <= o3.evaluateDate(t).getTime();
          }
          case opStrLike:
        ...
        switch (tag) {
          case opAnyNeg:
            return val instanceof Double || val instanceof Float 
                ? (Object)new Double(-Number.doubleValue(val))
                : (Object)new Long(-Number.longValue(val));
          case opAnyAbs:
            if (val instanceof Double || val instanceof Float) { 
                double rval = Number.doubleValue(val);
                return new Double(rval < 0 ? -rval : rval);
            } else { 
                long ival = Number.longValue(val);
    ...
    Object evaluateObj(FilterIterator t) { 
        ...
        if (base == null) { 
            if (t.containsElem != null) { 
                ...
                if ((m = QueryImpl.lookupMethod(cls, fieldName)) != null) {
                    this.m = m;
                    return t.query.resolve(m.invoke(obj));
                }
            }
...
class LoadNode extends Node {
    ...
    Class getDeclaringClass() { 
        return field.getDeclaringClass().getDescribedClass();
    }
...
class ContainsNode extends Node implements Comparator { 
    ...
    public int compare(Object o1, Object o2) {
        ...
        if (groupByMethod != null) { 
            return DefaultComparator.instance.compare(groupByMethod.invoke(o1), groupByMethod.invoke(o2));
        } 
        switch (groupByType) 
        { 
            case tpInt:
            ...
            default:
                return DefaultComparator.instance.compare(groupByField.get(o1), groupByField.get(o2));
        }
    }
    ...
    boolean evaluateBool(FilterIterator t) { 
        ...
        if (havingExpr != null && (withExpr != null || !(collection instanceof Vector))) { 
            n = (collection instanceof Vector) 
                ? ((Vector)collection).size() : ((Object[])collection).length;
        ...
        if (collection instanceof Vector) { 
            if (withExpr != null) { 
                Object elem;
                Enumeration iterator = ((Vector)collection).elements();
                ...
                Vector v = (Vector)collection;
                sortedArray = new Object[v.size()];
                for (i = 0; i < sortedArray.length; i++) { 
                    sortedArray[i] = v.elementAt(i);
                }
        ...
        if (groupByFieldName != null && len > 0) {
            ...
            if (groupByField == null) { 
                groupByMethod = QueryImpl.lookupMethod(type, groupByFieldName);
                if (groupByMethod == null) { 
...
class OrderNode {
    ...
    final int compare(Object a, Object b) { 
        int diff;
        if (method != null) {
            diff = DefaultComparator.instance.compare(method.invoke(a), method.invoke(b));
        } else { 
            switch (type) 
            { 
                case Types.Boolean:
                ...
                case Types.String:
                {
                    String l = (String)field.get(a);
                    String r = (String)field.get(b);
                    if (l == r) { 
                        diff = 0;
                    } else if (l == null) { 
                        diff = -1;
                        ...
                        diff = l.toLowerCase().compareTo(r.toLowerCase());
                    } else { 
                        diff = l.compareTo(r);
                    }
                    break;
                ...
                case Types.Date:
                {
                    Date l = (Date)field.get(a);
                    Date r = (Date)field.get(b);
                    if (l == r) { 
                        diff = 0;
                    } else if (l == null) { 
                        diff = -1;
                        ...
                        long t1 = l.getTime();
                        long t2 = r.getTime();
                        diff = t1 < t2 ? -1 : t1 == t2 ? 0 : 1;
                    }
                    break;
                }
                default:
                    diff = ((org.garret.perst.Comparable)field.get(a)).compareTo(field.get(b));
                    break;
            }
        }
        if (diff == 0 && next != null) { 
    ...
    {
        isCaseInsensitive = field != null && (field.getModifiers() & Modifier.CaseInsensitive) != 0;
    }

    void resolveName(Class cls) { 
        field = QueryImpl.lookupField(cls, fieldName);
        if (field == null) { 
            method = QueryImpl.lookupMethod(cls, fieldName);
            if (method == null) { 
                throw new JSQLNoSuchFieldException(cls, fieldName);
            }
        } else { 
...
class ParameterNode extends LiteralNode {
    ...
    long    evaluateInt(FilterIterator t) {
        return Number.longValue(params.get(index));
    }
    double  evaluateReal(FilterIterator t) {
        return Number.doubleValue(params.get(index));
    }
    String  evaluateStr(FilterIterator t) {
...
{
    public Iterator select(Class cls, Iterator iterator, String query) throws CompileError
    {
        this.query = query;
    ...
    public Iterator select(String className, Iterator iterator, String query) throws CompileError
    ...
    {      
        if (classExtentLock == ClassExtentLockType.Shared) { 
            ((IResource)classExtent).sharedLock();
        } else if (classExtentLock == ClassExtentLockType.Exclusive) { 
        ...
        try { 
            ...
            if (result == null) { 
                if (tree == null && order != null && order.next == null) {
                    ...
                    if (index != null) {
                        return filter(index.iterator(null, null, order.ascent ? Index.ASCENT_ORDER : Index.DESCENT_ORDER), null);
                    }
                }
                if (storage.listener != null) { 
    ...
    public void setClassExtent(Collection set, ClassExtentLockType lock)
    {
        classExtent = set;
    ...
    private static Key keyLiteral(int type, Node node, boolean inclusive) {
        Object value = ((LiteralNode)node).getValue();
        switch (type) { 
        case Types.Long:
            return new Key(Number.longValue(value), inclusive);
        case Types.Int:
            return new Key(Number.intValue(value), inclusive);
        case Types.Short:
            return new Key(Number.shortValue(value), inclusive);
        case Types.Char:
            return new Key((char)Number.shortValue(value), inclusive);
        case Types.Byte:
            return new Key(Number.byteValue(value), inclusive);
        case Types.Float:
            return new Key(Number.floatValue(value), inclusive);
        case Types.Double:
            return new Key(Number.doubleValue(value), inclusive);
        case Types.Boolean:
            return new Key(((Boolean)value).booleanValue(), inclusive);                
        case Types.String:
            return new Key(value.toString(), inclusive);     
        case Types.ArrayOfByte:
            return new Key((byte[])value, inclusive);
        case Types.Date:
            return new Key((Date)value, inclusive);     
        case Types.Object:
            return new Key((IPersistent)value, inclusive);     
        }
        return null;
    }
    ...
    Hashtable     resolveMap;
    IndexProvider indexProvider;
    Collection    classExtent;
    ...
    final int scan() {
        ...
        char ch = 0;
        int i;
        while (p < eol && isWhitespace(ch = buf[p])) { 
            p += 1;
        }
        if (p == eol) { 
            return tknEof;
        ...
        switch (ch) { 
          ...
          default:
            if (isLetter(ch) || ch == '$' || ch == '_') { 
                i = p-1;
                while (p < eol && (isLetterOrDigit(ch = buf[p]) 
                                   || ch == '$' || ch == '_'))
                {
                    p += 1;
                }
    ...
    static boolean isCaseInsensitive(Node node) { 
        ...
        return f != null && (f.getModifiers() & Modifier.CaseInsensitive) != 0;
    }
    ...
    static Method lookupMethod(Class cls, String ident) 
    { 
        Type type = ReflectionProvider.getInstance().getType(cls);
        if (type != null) { 
            Method m = type.getMethod(ident);
            if (m == null) { 
                ident = "get" + Character.toUpperCase(ident.charAt(0)) + ident.substring(1);
                m = type.getMethod(ident);
            }
        }  
        return null;
    }

    static Field lookupField(Class cls, String ident) 
    { 
        Type type = ReflectionProvider.getInstance().getType(cls);
        return type != null ? type.getField(ident) : null;
    }
    ...
    final Node component(Node base, Class cls) { 
        ...
        if (lex != tknLpar) { 
            if (base == null && contains != null) { 
                f = QueryImpl.lookupField(contains.containsFieldClass, ident);
                if (f != null) {
                    return new ElementNode(contains.containsExpr.getFieldName(), f);
                }
            } else if (cls != null) { 
                f = QueryImpl.lookupField(cls, ident);                    
                if (f != null) { 
        ...
        if (lex == tknLpar) { 
            ...
            lex = scan();
            arguments = new Node[argumentList.size()];
            for (int i = 0; i < arguments.length; i++) { 
                arguments[i] = (Node)argumentList.get(i);
            }
        }
        Method m = null;
        if (base == null && contains != null) { 
            m = lookupMethod(contains.containsFieldClass, ident);
            if (m != null) {
        ...
        } else if (base == null && contains != null && contains.containsFieldClass == Object.class){ 
    ...
    final Node containsElement() {
        ...
        if (arrClass == null || (!arrClass.isArray() && arrClass != Object.class && arrClass != Vector.class))
        { 
            throw new CompileError("Contains clause can be applied only to arrays or collections", p);
        }
        Class arrElemType = Object.class;
        p = pos;
        ...
        if (lex == tknGroup) { 
            ...
            if (arrElemType == Object.class) { 
                innerContains.groupByFieldName = ident;
            } else {
                Field groupByField = QueryImpl.lookupField(arrElemType, ident);
                if (groupByField == null) { 
                    Method groupByMethod = lookupMethod(arrElemType, ident);
                    if (groupByMethod == null) {
    ...
    final Iterator filter(Iterator iterator, Node condition) { 
    ...
    final Iterator binOpIndex(GenericIndex index, BinOpNode cmp)
    {
        ...
        case Node.opScanCollection:
            return new UnionIterator(index, null, (Vector)((LiteralNode)cmp.right).getValue());
        case Node.opObjEq:
        case Node.opAnyEq:
        case Node.opIntEq:
        case Node.opRealEq:
    ...
    class IndexSearchResult { 
        ...
        IndexSearchResult(Iterator iterator, Field key) { 
            this.iterator = iterator;
            this.key = key;
        }
    }
            ...
            case Node.opBoolOr:
            {
                 ...
                 if (isEqComparison(or.left) && ((BinOpNode)or.left).right instanceof LiteralNode) { 
                     ...
                     while (right instanceof BinOpNode) { 
                         ...
                         alternatives.addElement(((LiteralNode)((BinOpNode)cmp).right).getValue());
                     }
                     if (right != null) { 
                         return null;
                     }
    ...
    final void compile() {
        ...
        do { 
            ...
            OrderNode node;
            Field f = QueryImpl.lookupField(cls, ident);
            if (f == null) {
                Method m = lookupMethod(cls, ident);
                if (m == null) { 
                    if (cls != Object.class) {
                ...
                node = new OrderNode(Types.getTypeCode(f.getType()), f);
            }
            if (last != null) { 
                last.next = node;
            } else { 
