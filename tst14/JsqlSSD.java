            ...
            try { 
                                       ...
                                       "9. Exit\n\n>>"))
                {
                  ...
                  case 7:
                    ...
                    iterator = detailQuery.execute(db.getRecords(Detail.class));
                    result = new HashSet();
                    while (iterator.hasNext()) {                         
                        detail = (Detail)iterator.next();
                        for (i = detail.shipments.size(); --i >= 0;) { 
                            shipment = (Shipment)detail.shipments.get(i);
                            System.out.println("Shipment supplier: " + shipment.supplier);
                  ...
                  case 8:
                    ...
                    iterator = supplierQuery.execute(db.getRecords(Supplier.class));
                    result = new HashSet();
                    while (iterator.hasNext()) {                         
                        supplier = (Supplier)iterator.next();
