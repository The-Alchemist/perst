 ...
 */
public interface Link extends ITable {
    /**
   ...
   /**
    ...
    /**
     * Remove object from relation, this method is equivalent to remove(indexOf(obj))
     * @param obj specified object
     * @return true if object is successfully removed from the relation, false if it is not present in this link
     */
