 ...
 * "select from StockOptions where Symbol between 'AAB' and 'ABC' and Price %gt; 100 and Volume between 1000 and 10000".
 * Each component of the object is represented as separate dimension in the index.
 */
public interface MultidimensionalIndex extends IPersistent, IResource, ITable 
{
    /**
