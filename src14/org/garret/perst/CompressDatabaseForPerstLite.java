...
public class CompressDatabaseForPerstLite {
    static final int PAGE_SIZE = org.garret.perst.impl.Page.pageSize;
    ...
    { 
        if (args.length == 0 || args.length > 2) { 
            System.err.println("Usage: java org.garret.perst.CompressDatabaseForPerstLite DATABASE_FILE_PATH [cipher-key]");
            return;
        }
        String path = args[0];
