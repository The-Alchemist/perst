...
public class KDTree extends PersistentResource implements MultidimensionalIndex {
    ...
    KDTree(Storage storage, Class cls, String[] fieldNames, boolean treateZeroAsUndefinedValue) { 
        super(storage);
        this.comparator = new ReflectionMultidimensionalComparator(storage, cls, fieldNames, treateZeroAsUndefinedValue);
    }
    ...
    public class KDTreeIterator implements PersistentIterator 
    { 
        KDTreeNode[] stack;
        int          sp;
        int          nDims;
