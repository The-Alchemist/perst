                        ...
                        if ((mask & bit) != 0) { 
                            ...
                            try { 
                                ...
                                if (desc.cls == Btree.class) { 
                                    ...
                                    exportSet(oid, obj);
                                } else if (desc.cls == BtreeFieldIndex.class || desc.cls == BtreeCaseInsensitiveFieldIndex.class) { 
                                    exportFieldIndex(oid, obj, desc.name);
                                } else if (desc.cls == BtreeMultiFieldIndex.class || desc.cls == BtreeCaseInsensitiveMultiFieldIndex.class) { 
                                    exportMultiFieldIndex(oid, obj, desc.name);
