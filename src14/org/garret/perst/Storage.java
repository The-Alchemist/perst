...
public interface Storage { 
     ...
     * @return scalable persistent map implementation
     */
     ...
     * specified key type is not supported by implementation.
     */
    public Index createIndex(Class[] types, boolean unique);
     ...
     * specified key type is not supported by implementation.
     */
    public Index createRandomAccessIndex(Class type, boolean unique);
     ...
     * specified key type is not supported by implementation.
     */
    public Index createRandomAccessIndex(Class[] types, boolean unique);
     ...
     * StorageError(StorageError.UNSUPPORTED_INDEX_TYPE) exception if type of specified field is not supported by implementation
     */
    public FieldIndex createRandomAccessFieldIndex(Class type, String[] fieldNames, boolean unique, boolean caseInsensitive);
     ...
     * <code>Storage.clearObjectCache()</code> method. <B>Weak</B> cache uses weak references and
