...
public class TestIndexIterator { 
    ...
    static public void main(String[] args) {    
        ...
        for (int i = 0; i < args.length; i++) { 
            ...
            } else if ("concurrent".equals(args[i])) { 
                db.setProperty("perst.concurrent.iterator", Boolean.TRUE);
            } else { 
        ...
        if (root == null) { 
            root = new Indices();
            root.strIndex = db.<Record>createIndex(String.class, false);
            root.intIndex = db.<Record>createIndex(long.class, false);
            db.setRoot(root);
        }
        ...
        start = System.currentTimeMillis();
        Iterator<Record> iterator = intIndex.iterator(null, null, Index.ASCENT_ORDER);
        ...
        System.out.println("\nElapsed time for performing " + nRecords*2 + " delete operations: " 
                           + (System.currentTimeMillis() - start) + " milliseconds");
