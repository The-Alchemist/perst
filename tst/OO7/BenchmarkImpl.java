...
//
// $Id: BenchmarkImpl.java 2147 2007-05-15 21:57:47Z builder $
...
public class BenchmarkImpl extends Persistent implements Benchmark {
    ...
    private final static int[] fNumAtomicPerComp = {20, 20, 20, 20, 20};
    private final static int[] fConnPerAtomic = {1, 3, 3, 3, 10};
    private final static int[] fDocumentSize = {20, 20, 20, 2000, 8000};
    private final static int[] fManualSize = {1000, 1000, 1000, 100000, 200000};
    private final static int[] fNumCompPerModule = {5, 5, 50, 500, 5000};
    private final static int[] fNumAssmPerAssm = {3, 3, 3, 3, 3};
    private final static int[] fNumAssmLevels = {3, 3, 7, 7, 10};
    private final static int[] fNumCompPerAssm = {3, 3, 3, 3, 3};
    private final static int[] fNumModules = {1, 1, 1, 1, 1};
