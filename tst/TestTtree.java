...
class NameComparator extends PersistentComparator<Person> { 
...
public class TestTtree { 
    ...
    static public void main(String[] args) {    
        ...
        if (root == null) { 
            root = new PersonList();
            root.list = db.<Person>createSortedCollection(new NameComparator(), true);
            db.setRoot(root);
        }
        SortedCollection<Person> list = root.list;
        long key = 1999;
        int i;
